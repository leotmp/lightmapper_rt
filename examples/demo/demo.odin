...
main :: proc()
{
    ...
    white_texture := shared.create_1x1_texture(&upload_arena, upload_cmd_buf, {255,255,255,255})
    ...
    gltf_scene, lm_size := shared.load_scene_gltf(glb_contents, &desc_pool, skip_lightmap, LM_TARGET_SIZE)
    defer {
    ...
    if gbuf_world_pos_tex == {} {
        gbuf_world_pos_tex = white_texture
        gbuf_world_normals_tex = white_texture
    }
